...
export default function HomePage() {
  return (
    ...
    <LazyNewsSection />
      ...
      <p className="first-letter:text-4xl first-letter:font-bold first-letter:leading-none text-lg text-gray-600 ">Полтавський художній музей (галерея мистецтв) імені Миколи Ярошенка розташована у затишному куточку центральної частини міста. Галерея дуже швидко набула популярності у полтавців. Це заклад культури нового зразка з просторими залами, холом, анфіладами, прес-центром на 100 місць і «зимовим садом», загальною площею більше 2 тис. кв. м.</p>
      <p className="first-letter:text-4xl first-letter:font-bold first-letter:leading-none text-lg text-gray-600 max-w-4xl mx-auto mt-4">У 2000 році до приміщення Галереї мистецтв через катастрофічний стан власної «домівки», колишнього маєтку поміщика Болюбаша – будівлі 1912 року, переїхав Полтавський художній музей. Тут він отримав постійну прописку, розмістивши експозицію у трьох анфіладах першого поверху, а фонди – у спеціально обладнаному фондосховищі.</p>
      <p className="first-letter:text-4xl first-letter:font-bold first-letter:leading-none text-lg text-gray-600 max-w-4xl mx-auto mt-4">У 2008 році Полтавський художній музей (галерея мистецтв) отримала, нарешті, ім’я Миколи Ярошенка.</p>
      <p className="first-letter:text-4xl first-letter:font-bold first-letter:leading-none text-lg text-gray-600 max-w-4xl mx-auto mt-4">У 2001 році до складу музею увійшла дитяча художня галерея  імені Саші Путрі, яка діє в окремій затишній залі художнього музею. Отже, Полтава має приклад закладу культури нового зразка, де одночасно взаємодіють усі існуючі види мистецтв.
      </p>
    </div>
		       </section>
      </main>
