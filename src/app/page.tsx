...
export default function HomePage() {
  return (
    ...
    <LazyNewsSection />
      ...
      <p className="text-lg text-gray-600 ">Полтавський художній музей (галерея мистецтв) імені Миколи Ярошенка розташована у затишному куточку центральної частини міста. Галерея дуже швидко набула популярності у полтавців. Це заклад культури нового зразка з просторими залами, холом, анфіладами, прес-центром на 100 місць і «зимовим садом», загальною площею більше 2 тис. кв. м.</p>
